...
#? La función pregunta_01() lee un archivo de texto, procesa su contenido para extraer información sobre clusters, y devuelve un DataFrame de Pandas con los datos estructurados.
print(pregunta_01())